<?php
    class Post_Banners {
        ...
        public function getPostsById($id) {
            $this->db->query("SELECT * FROM v_posts_banners WHERE userId = :id ORDER BY post_id DESC;");     
            $this->db->bind(":id", $id);       
        ...
        public function getPostById($id) {
            $this->db->query('SELECT * FROM v_posts_banners WHERE post_id = :id');
            $this->db->bind(':id', $id);
        ...
        public function updateBannerAsPayed($id) {
            ...
            $this->db->bind(":amount", BANNER_PRICE); 
