                    ...
                    <div class="middle-panel-single">
                        ...
                        <form action="<?php echo URLROOT.'/C_O_Settings/editSettingsUniversity'; ?>" method="post">
                            <div class="settings-header">
                                    ...
                                    <div class="settings-header-item"><a href="<?php echo URLROOT.'/C_O_Settings/settings/'.$_SESSION['user_id']; ?>"><input class="cancel-button" type="button" value="Cancel"></a></div>
