<html lang="en">
    ...
    <body>
        ...
        <div class="main-content">
            ...
            <main>
                <div class="wrapper">
                    <!-- TOP PANEL -->
                    <div class="top-panel">
                        <h1>student profile > Higher Education details Edit</h1>
                    </div>
        ...
        <!-- ol edit js -->
        <script type="text/JavaScript" src="<?php echo URLROOT; ?>/js/studentRelated/opt_settings/edit/ugEdit.js"></script>
