                ...
                <div class="wrapper">
                    ...
                    <div class="middle-panel-single">
                        ...
                        <div class="settings-header">
                            ...
                            <div class="settings-header-item"><a href="<?php echo URLROOT; ?>/C_S_Settings/editSettingsOL"><input class="edit-button" type="button" value="Edit"></a></div>
                        </div>
                        <br>
                        <div class="table-section"> 
                        <table class="settings-table">
                        ...
                        <div class="settings-header">
                            ...
                            <div class="settings-header-item"><a href="<?php echo URLROOT; ?>/C_S_Settings/editSettingsAL"><input class="edit-button" type="button" value="Edit"></a></div>
                        </div>
                        <br>
                        <div class="table-section"> 
                        <table class="settings-table">
                        ...
                        <div class="settings-header">
                            ...
                            <div class="settings-header-item"><a href="<?php echo URLROOT; ?>/C_S_Settings/editSettingsUG"><input class="edit-button" type="button" value="Edit"></a></div>
                        </div>
                        <br>   
                        <div class="table-section"> 
                        <table class="settings-table">
