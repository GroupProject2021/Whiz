        ...
        <div class="left">
            ...
            <div class="rate-stars">
                <?php for($i = 1; $i <= round($data['avg_rate'], 0); $i++): ?>
                    <div class="star active"><img src="<?php echo URLROOT.'/imgs/components/ratingSystem/star-icon.png'; ?>" alt=""></div>
                <?php endfor; ?>
                <?php for($i = round($data['avg_rate'], 0) + 1; $i <= 5; $i++): ?>
                    <div class="star"><img src="<?php echo URLROOT.'/imgs/components/ratingSystem/star-icon.png'; ?>" alt=""></div>
                <?php endfor; ?>
            </div>
            <div class="total-text">Total Reviews</div>
            <div class="total-rate-amount">
                <div class="user-icon"><img src="<?php echo URLROOT.'/imgs/components/ratingSystem/user-icon.png'; ?>" alt=""></div>
