...
<div class="sidebar">
    ...
    <div class="sidebar-brand">
        <div class="brand-flex">
            ...
            <div class="brand-icons">
                ...
                <a href="<?php echo URLROOT; ?>/University_Dashboards/settings"><img src="<?php echo URLROOT; ?>/imgs/sidebar/settings.png"></a>
            </div>
        </div>
    </div>
    ...
    <?php if(isset($_SESSION['user_id'])) : ?>
        ...
        <div class="sidebar-item">
            <a href="<?php echo URLROOT; ?>/University_Dashboards/course">
                <button>
        ...
        <div class="sidebar-item">
            <a href="<?php echo URLROOT; ?>/University_Dashboards/index">
                <button>
                    <div class="sidebar-item-icon">
