            ...
            <main>
                <div class="wrapper">
                    ...
                    <div class="middle-panel-single">
                        <a href="<?php echo URLROOT.'/C_A_ZScore_Options/addZScoreEntry'; ?>" class="btn1-small form-link">Add Z-Score entry</a>
                        ...
                        <table border="1">
                            ...
                            <tr>
                                ...
                                <?php
                                        ...
                                        if($z_record->district_name == "Colombo") {
                                            echo '<td>';
                                            echo '<a href="'.URLROOT.'/C_A_ZScore_Options/editZScoreEntry/'.$z_record->unicode.'">Edit</a>';
                                            echo '<br>';
                                            //echo '<a href="'.URLROOT.'/C_A_ZScore_Options/deleteZScoreEntry/'.$z_record->unicode.'">Delete</a>';
                                            echo '</td>';
                                        }
                                    }
                                ?>
