            ...
            <main>
                <div class="wrapper">
                    ...
                    <div class="middle-panel-single">
                        <form action="<?php echo URLROOT; ?>/C_A_ZScore_Options/addZScoreEntry" method="post">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <select name="course_of_study" id="course_of_study" class="form-select">
                                            <?php foreach($data['course_university_list'] as $courseUni):?>                                                
                                                <option value="<?php echo $courseUni->unicode; ?>"><?php echo '<b>'.$courseUni->gov_course_name.'</b> ('.$courseUni->uni_name.')'; ?></option>
                                            <?php endforeach; ?>
                                        </select>   
                                    </td>
                                </tr>  
