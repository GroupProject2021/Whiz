        ...
        <div class="main-content">            
            ...
            <main>
                <div class="wrapper">
                    <!-- TOP PANEL -->
                    <div class="top-panel">
                        <h1>Edit Courses and University</h1>
                    </div>
                                    ...
                                    <td>
                                        <select name="courses" id="courses" class="form-select">
                                            <?php foreach($data['courses_list'] as $course):?>
                                                <?php if($course->gov_course_id == $data['course']): ?>
                                                    <option value="<?php echo $course->gov_course_id; ?>" selected><?php echo $course->gov_course_name; ?></option>
                                                <?php endif; ?>
                                    ...
                                    <td>
                                        <select name="universities" id="universities" class="form-select">
                                            <?php foreach($data['universities_list'] as $university):?>
                                                <?php if($university->gov_uni_id == $data['university']): ?>
                                                    <option value="<?php echo $university->gov_uni_id; ?>" selected><?php echo $university->uni_name; ?></option>
                                                <?php endif; ?>
