<?php
    class Posts_C_O_Advertisement extends Controller {
        ...
        public function add() {
            if($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if($data['image']['size'] > 0) {
                    if(uploadImage($data['image']['tmp_name'], $data['image_name'], '/imgs/posts/advertisements/')) {
        ...
        public function edit($id) {
            if($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if(updateImage($oldImage, $data['image']['tmp_name'], $data['image_name'], '/imgs/posts/advertisements/')) {
                    // flash('profile_image_upload', 'Profile picture uploaded successfully');
                }
                else {
                    // upload unsuccessfull
